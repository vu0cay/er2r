...
INSERT INTO HOCVIEN VALUES('HV0012','L? Huy?n Trang',0,'2000-11-02','0917217036','Phong ?i?n- C?n Th?');

INSERT INTO PHIEUTHU values ('PT000071','HV0012','L001','2021-06-02',1350000);

INSERT INTO LOP values ('L004','LL002','L?p 4',30,'K001');
...
UPDATE PHIEUTHU
    SET THANHTIEN = 1350000
    WHERE MALOP = 'L001';
UPDATE PHIEUTHU
    SET THANHTIEN = 1450000
    WHERE MALOP = 'L003';
...
UPDATE HOCVIEN_NAM AS HOCVIEN
    ...
    WHERE HOCVIEN(GIOITINH) = 1;


ALTER TABLE HOCVIEN_NAM DROP GIOITINH;
...
--        FROM HOCVIEN
--        WHERE GIOITINH = 1 );
--ALTER TABLE HOVIEN_NAM DROP GIOITINH;
--
--                       
                        
DROP TABLE HOCVIEN_NAM
select * from HOVIEN_NAM
